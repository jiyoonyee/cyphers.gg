...
async function searchPlayerInfo(playerId,gameTypeId){
    try{
      ...
      averageKill = (totalKill/totalMatch)*10
      averageDeadth = (totalDeadth/totalMatch)*10
      averageAssist = (totalAssist/totalMatch)*10
      averageKDA = ((averageKill+averageAssist)/averageDeadth).toFixed(1);

      $kill.innerHTML = averageKill;
      $deadth.innerHTML = averageDeadth;
      $assist.innerHTML = averageAssist;
      $KDA.innerHTML = averageKDA;
